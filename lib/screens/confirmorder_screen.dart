  ...
  Future<void> calldeliverslots(String addressid) async {
    ...
    Provider.of<DeliveryslotitemsList>(context,listen: false)
      ...
      for(int i = 0; i < deliveryslotData.items.length; i++) {
        ...
        print("values......"+values.toString());  // {0: grubs, 1:  sheep}
                                                      ...
                                                      children: [
                                                       ...
                                                       // Spacer(),
                                                        IconButton(
                                                          ...
                                                          onPressed: () {
                                                            Navigator.of(context).pop();
                                                                 debugPrint("dfvcx...."+productBox
                                                                     .where((element) =>
                                                                 element.id == DefaultSlot[i].id).toString()+",........."+DefaultSlot[i].id.toString());
                                                            // _dialogforDeleting();
                                                            _updateCart(0, CartStatus.remove,
                                                              DefaultSlot[i].varId
                                                                  .toString(),
    ...
    switch (cart) {
      ...
      case CartStatus.remove:
        cartcontroller.update((done){
          ...
          topping_id: "",);
        debugPrint("gfcvb..."+productBox.length.toString());
