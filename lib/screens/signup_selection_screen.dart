            ...
            child: Column(children: <Widget>[
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                            prefixIcon: Image.asset(Images.countryImg),
                  ...
                  Form(
                      ...
                      TextFormField(
                        ...
                        decoration: InputDecoration(
                            ...
                            prefixIcon: Image.asset(Images.phoneImg),
              ...
              Container(
                ...
                child: Text(
                  ...
                  style: TextStyle(fontSize: 13, color: IConstants.isEnterprise? ColorCodes.primaryColor:ColorCodes.liteColor),
                ),
              ),
              GestureDetector(
                onTap: () {
              ...
              Container(
                width: MediaQuery.of(context).size.width / 1.2,
                height: MediaQuery.of(context).size.height / 18,//30.0,
                ...
                child: new RichText(
                  text: new TextSpan(
                    ...
                    style: new TextStyle(
                      fontSize: 13.0,
                      color: IConstants.isEnterprise? ColorCodes.primaryColor:ColorCodes.liteColor,//Colors.black,
                    ),
                    children: <TextSpan>[
