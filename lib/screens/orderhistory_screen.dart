          ...
          children: [
            ...
            if (double.parse(orderitemData.vieworder[0].totalDiscount) != 0)
              Container(
                width: MediaQuery.of(context).size.width /*- 20*/,
                alignment: Alignment.centerLeft,
                decoration: BoxDecoration(color: ColorCodes.varcolor/*ColorCodes.lightgreen*/),
                    ...
                    children: [
                      ...
                      arguments: {
                        ...
                        child: Container(
                          ...
                          alignment: Alignment.centerLeft,
                          decoration:
                              BoxDecoration(color: ColorCodes.varcolor/*ColorCodes.lightgreen*/),
                          height: 45,
