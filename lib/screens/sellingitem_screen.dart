...
class _SellingitemScreenState extends State<SellingitemScreen>with Navigations {
  ...
  void initState() {
    ...
    Future.delayed(Duration.zero, () async {
      ...
      final seeallpress = widget.params['seeallpress'];
       ...
       print("title...cart...."+title.toString());
      ...
      print("title...cart....after"+title.toString());
      try {
        if (Platform.isIOS) {
          setState(() {
            _isWeb = false;
  ...
  Widget build(BuildContext context) {
    ...
    Features.btobModule?(deviceWidth - (20 + ((widgetsInRow - 1) * 10))) / widgetsInRow / 210:(deviceWidth - (20 + ((widgetsInRow - 1) * 10))) / widgetsInRow / 150;
    final routeArgs = ModalRoute.of(context)!.settings.arguments as Map<String, dynamic>;
