...
class PageControler extends Navigations  {
  ...
  return HomeScreen(key: state.pageKey);},
      ...
      GoRoute(name: nUri(Routename.NotAvailability).name,path: nUri(Routename.NotAvailability).path+"/:val/:currentbranch", builder: (context, state) =>NotavailabilityProduct(state.params),),
